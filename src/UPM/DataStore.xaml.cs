...
namespace Expression.Blend.DataStore.DataStore
{
	...
	public class DataStoreGlobalStorage
	{
		...
		private string _played = string.Empty;
	...
	public class DataStore : System.ComponentModel.INotifyPropertyChanged
	{
		...
		public DataStore()
		{
			try
			{
				System.Uri resourceUri = new System.Uri("/UPM;component/DataStore/DataStore/DataStore.xaml", System.UriKind.Relative);
		...
		public string played
		{
			get
			{
				return DataStoreGlobalStorage.Singleton.played;
			}

			set
			{
				DataStoreGlobalStorage.Singleton.played = value;
			}
		}
	}
}
